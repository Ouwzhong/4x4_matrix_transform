...
WORD** H_transform(int height, int width, BYTE** X){
	...
	WORD* Ypart0 = (WORD *)calloc(4,sizeof(WORD));
	WORD* Ypart1 = (WORD *)calloc(4,sizeof(WORD));
	WORD* Ypart2 = (WORD *)calloc(4,sizeof(WORD));
	WORD* Ypart3 = (WORD *)calloc(4,sizeof(WORD));
	WORD** Ypart = (WORD **)calloc(4,sizeof(WORD*));
	Ypart[0] = Ypart0;
	Ypart[1] = Ypart1;
	Ypart[2] = Ypart2;
	Ypart[3] = Ypart3;
	...
	int true_x, true_y;
	//for (true_y=0; true_y<height; true_y+=4){
		for (true_x=0; true_x<width; true_x+=4){
			//true_x = 4*x;
			//true_y = 4*y;
			...
			Ypart[0][0] = X[true_y][true_x] + X[true_y+1][true_x] + X[true_y+2][true_x] + X[true_y+3][true_x];
			Ypart[0][1] = X[true_y][true_x+1] + X[true_y+1][true_x+1] + X[true_y+2][true_x+1] + X[true_y+3][true_x+1];
			Ypart[0][2] = X[true_y][true_x+2] + X[true_y+1][true_x+2] + X[true_y+2][true_x+2] + X[true_y+3][true_x+2];
			Ypart[0][3] = X[true_y][true_x+3] + X[true_y+1][true_x+3] + X[true_y+2][true_x+3] + X[true_y+3][true_x+3];

			Ypart[1][0] = 2*X[true_y][true_x] + X[true_y+1][true_x] - X[true_y+2][true_x] - 2*X[true_y+3][true_x];
			Ypart[1][1] = 2*X[true_y][true_x+1] + X[true_y+1][true_x+1] - X[true_y+2][true_x+1] - 2*X[true_y+3][true_x+1];
			Ypart[1][2] = 2*X[true_y][true_x+2] + X[true_y+1][true_x+2] - X[true_y+2][true_x+2] - 2*X[true_y+3][true_x+2];
			Ypart[1][3] = 2*X[true_y][true_x+3] + X[true_y+1][true_x+3] - X[true_y+2][true_x+3] - 2*X[true_y+3][true_x+3];

			Ypart[2][0] = X[true_y][true_x] - X[true_y+1][true_x] - X[true_y+2][true_x] + X[true_y+3][true_x];
			Ypart[2][1] = X[true_y][true_x+1] - X[true_y+1][true_x+1] - X[true_y+2][true_x+1] + X[true_y+3][true_x+1];
			Ypart[2][2] = X[true_y][true_x+2] - X[true_y+1][true_x+2] - X[true_y+2][true_x+2] + X[true_y+3][true_x+2];
			Ypart[2][3] = X[true_y][true_x+3] - X[true_y+1][true_x+3] - X[true_y+2][true_x+3] + X[true_y+3][true_x+3];

			Ypart[3][0] = X[true_y][true_x] - 2*X[true_y+1][true_x] + 2*X[true_y+2][true_x] - X[true_y+3][true_x];
			Ypart[3][1] = X[true_y][true_x+1] - 2*X[true_y+1][true_x+1] + 2*X[true_y+2][true_x+1] - X[true_y+3][true_x+1];
			Ypart[3][2] = X[true_y][true_x+2] - 2*X[true_y+1][true_x+2] + 2*X[true_y+2][true_x+2] - X[true_y+3][true_x+2];
			Ypart[3][3] = X[true_y][true_x+3] - 2*X[true_y+1][true_x+3] + 2*X[true_y+2][true_x+3] - X[true_y+3][true_x+3];


			Y[true_y][true_x] = Ypart[0][0] + Ypart[0][1] + Ypart[0][2] + Ypart[0][3];
			Y[true_y+1][true_x] = Ypart[1][0] + Ypart[1][1] + Ypart[1][2] + Ypart[1][3];
			Y[true_y+2][true_x]= Ypart[2][0] + Ypart[2][1] + Ypart[2][2] + Ypart[2][3];
			Y[true_y+3][true_x] = Ypart[3][0] + Ypart[3][1] + Ypart[3][2] + Ypart[3][3];

			Y[true_y][true_x+1] = 2*Ypart[0][0] + Ypart[0][1] - Ypart[0][2] - 2*Ypart[0][3];
			Y[true_y+1][true_x+1] = 2*Ypart[1][0] + Ypart[1][1] - Ypart[1][2] - 2*Ypart[1][3];
			Y[true_y+2][true_x+1] = 2*Ypart[2][0] + Ypart[2][1] - Ypart[2][2] - 2*Ypart[2][3];
			Y[true_y+3][true_x+1] = 2*Ypart[3][0] + Ypart[3][1] - Ypart[3][2] - 2*Ypart[3][3];

			Y[true_y][true_x+2] = Ypart[0][0] - Ypart[0][1] - Ypart[0][2] + Ypart[0][3];
			Y[true_y+1][true_x+2] = Ypart[1][0] - Ypart[1][1] - Ypart[1][2] + Ypart[1][3];
			Y[true_y+2][true_x+2] = Ypart[2][0] - Ypart[2][1] - Ypart[2][2] + Ypart[2][3];
			Y[true_y+3][true_x+2] = Ypart[3][0] - Ypart[3][1] - Ypart[3][2] + Ypart[3][3];

			Y[true_y][true_x+3] = Ypart[0][0] - 2*Ypart[0][1] + 2*Ypart[0][2] - Ypart[0][3];
			Y[true_y+1][true_x+3] = Ypart[1][0] - 2*Ypart[1][1] + 2*Ypart[1][2] - Ypart[1][3];
			Y[true_y+2][true_x+3] = Ypart[2][0] - 2*Ypart[2][1] + 2*Ypart[2][2] - Ypart[2][3];
			Y[true_y+3][true_x+3] = Ypart[3][0] - 2*Ypart[3][1] + 2*Ypart[3][2] - Ypart[3][3];
